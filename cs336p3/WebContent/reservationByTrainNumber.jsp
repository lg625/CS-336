...
<%
String trainNumber=request.getParameter("TrainNumb");
session.putValue("TrainNumb",trainNumber);
...
ResultSet rs=st.executeQuery("SELECT * FROM full_reservations WHERE full_reservations.train_id =  '" + trainNumber +"'");
...
out.println("<TR>");
	out.println("<TH>Reservation(s) by Train: "+ trainNumber +"</TH>");
out.println("</TR>");
out.println("<TR>");
