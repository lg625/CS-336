...
session.putValue("CustName",name);
...
ResultSet rs=st.executeQuery("SELECT * FROM full_reservations WHERE full_reservations.purchase_id = '" + name+"'");
...
out.println("<TR>");
	out.println("<TH>Reservation(s) for Customer: "+name +" </TH>");
out.println("</TR>");
out.println("<TR>");
